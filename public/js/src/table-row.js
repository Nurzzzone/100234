...
$(document).ready(function () {
  var tableRow = $('tr[data-name="tableRow"]');
  ...
  var table = $('.table');
  var tableHeaders = $(table).find('th').length;
  ...
  $('#dismiss-success-button').on('click', function (e) {
    e.preventDefault();
    var successFlashMessage = $('#success-flash-alert');
  ...
  $('#dismiss-error-button').on('click', function (e) {
    e.preventDefault();
    var errorFlashMessage = $('#error-flash-alert');
...
/***/ 3:
/*!*****************************************!*\
  !*** multi ./resources/js/table-row.js ***!
  \*****************************************/
/*! no static exports found */
