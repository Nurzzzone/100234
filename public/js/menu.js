...
$(document).ready(function () {
  ...
  (function () {
    new NestedSort({
      ...
      el: '#menu',
      nestingLevels: 1,
      renderListItem: function renderListItem(element, _ref) {
        var id = _ref.id;
        $(element).append("\n                            <div class=\"float-right align-middle\">\n                                <button class=\"btn mr-2\"\n                                    data-toggle=\"modal\"\n                                    data-name=\"editModalButton\"\n                                    data-target=\"".concat(id, "\"\n                                    type=\"button\">").concat(svg.pencil, "</button>\n                                <button class=\"btn\"\n                                    data-toggle=\"modal\"\n                                    data-name=\"deleteModalButton\"\n                                    data-target=\"").concat(id, "\"\n                                    type=button>").concat(svg["delete"], "</button>\n                            <div>"));
        return element;
      }
    });
  })();
...
/***/ 0:
/*!****************************************************************!*\
  !*** multi ./resources/js/menu.js ./resources/sass/style.scss ***!
  \****************************************************************/
/*! no static exports found */
