                    ...
                    <div class="card">
                        <div class="card-body">
                            <table class="table table-striped table-bordered datatable mb-0">
                                <tbody>
                                    @include('partials.tr-text', ['data' => $object->name, 'locale' => trans('fields.manufacturer'), 'tr' => 'text'])
                                    @foreach($discount_makers  as $discount_maker)
                                        @include('partials.tr-text', ['data' => $discount_maker->limit,'label' => $discount_maker->name, 'tr' => 'text'])
                                    @endforeach
                                </tbody>
                            </table>
                        </div>
