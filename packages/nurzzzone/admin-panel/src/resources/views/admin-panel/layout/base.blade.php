...
<div id="global-loader"
     class="global-loader-wrapper position-absolute d-flex justify-content-center align-items-center flex-column">
...
<div class="c-app" id="app">
    ...
    <div class="c-wrapper">
        @include('admin-panel::shared.header.index')
        <div class="c-body">
            <main class="c-main">
                <div class="container-fluid">
                    @include('admin-panel::partials.flash-message')
                    @include('admin-panel::partials.validation')
                </div>
                @yield('content')
            </main>
            @include('admin-panel::shared.footer.index')
        </div>
    </div>
</div>

@include('admin-panel::shared.scripts')
</body>
</html>
