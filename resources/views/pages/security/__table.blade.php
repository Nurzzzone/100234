<table id="sortable-table" data-update-sequence-url="{{ route('security.updateSequence') }}" @class(['table-hover' => $objects->isNotEmpty(), 'table table-responsive-sm table-bordered border-top-0 mb-0'])>
    <thead>
    <tr>
